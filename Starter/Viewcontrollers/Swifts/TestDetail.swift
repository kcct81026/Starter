...
class TestDetailVC: UIViewController,ActorActionDelegate, MovieItemDelegate{
...
extension TestDetailVC: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
